									...
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											...
											<form action="sem2sow.php" method="post">
												<input type="submit"  value="Linux Programming" class="btn btn-success hvr-bounce-in"/>
								...
								<table class="table table-bordered">
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											<td style="background-color:align:center">																																		
											<form action="sem2sow.php" method="post">	
												<input type="submit" value="Discrete Mathematics" class="btn btn-success hvr-bounce-in"/>
								...
								<table class="table table-bordered">
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											<td style="background-color:align:center">	
											<form action="sem2sow.php" method="post">
												<input type="submit"  value="MPMC" class="btn btn-success hvr-bounce-in"/>
												<input type="hidden" name="id" value="11"/>
											</form>
											</td>
										</tr>
								...
								<table class="table table-bordered">
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											<td style="background-color:align:center">																																		
											<form action="sem2sow.php" method="post">	
												<input type="submit" value="Advance Data Structure" class="btn btn-success hvr-bounce-in"/>
												<input type="hidden" name="id" value="12"/>
											</form>
											</td>
										</tr>
