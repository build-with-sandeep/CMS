...
<html>
	...
	<body>
		...
		<div class="show">
            <marquee class="schl" direction = "left" width="50%"><h4>MASTERS IN COMPUTER APPLICATION</h4></marquee><br/>	
        <div class="container">
								...
								<table class="table table-bordered">
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											...
											<form action="courseshowmca.php" method="post">
									...
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											...
											<form action="courseshowmca.php" method="post">												
                                                ...
                                                <input type="submit" value="Semester 5" class="btn btn-success hvr-buzz-out"/>
											</form>
											</td>
										</tr>
									</tbody>
									...
									<tbody  style="background-color:#f1f1f1;align:center">
										<tr>
											...
											<form action="courseshowmca.php" method="post">												
                                                ...
                                                <input type="submit" value="Semester 6" class="btn btn-success hvr-buzz-out"/>
											</form>
											</td>
										</tr>
									</tbody>
